...
apt autoremove -y
apt install net-tools nmap telnet curl netcat plank sqlmap default-jre default-jdk python3 golang john aircrack-ng extract exiftool whois dirb nikto nbtscan gobuster samba smbclient flameshot -y
apt update && apt upgrade -y
apt autoremove -y
